...
CREATE TABLE IF NOT EXISTS sys_admin (
    ...
    password VARCHAR(255) NOT NULL COMMENT '密码',
    real_name VARCHAR(50) COMMENT '真实姓名',
    role TINYINT DEFAULT 0 COMMENT '角色：0-系统管理员 1-充电站管理员',
    status TINYINT DEFAULT 0 COMMENT '状态：0-正常 1-禁用',
    create_time DATETIME DEFAULT CURRENT_TIMESTAMP,
    update_time DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
...
CREATE TABLE IF NOT EXISTS evaluation_like (
    ...
    user_id BIGINT NOT NULL COMMENT '用户ID',
    create_time DATETIME DEFAULT CURRENT_TIMESTAMP,
    UNIQUE KEY uk_evaluation_user (evaluation_id, user_id),
...
CREATE TABLE IF NOT EXISTS time_price (
    id BIGINT PRIMARY KEY AUTO_INCREMENT,
    station_id BIGINT NOT NULL COMMENT '充电站ID',
    pile_id BIGINT COMMENT '充电桩ID，NULL表示全站通用',
    time_type TINYINT NOT NULL COMMENT '时段类型：0-峰时 1-平时 2-谷时',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='分时定价表';
...
INSERT INTO sys_admin (username, password, real_name, role) VALUES
                                                                ('admin', 'e10adc3949ba59abbe56e057f20f883e', '系统管理员', 0),
                                                                ('station_admin', 'e10adc3949ba59abbe56e057f20f883e', '充电站管理员', 1),
                                                                ('maintenance', 'e10adc3949ba59abbe56e057f20f883e', '运维人员', 2);
